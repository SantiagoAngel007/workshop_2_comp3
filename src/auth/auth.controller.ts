...
export class AuthController {
  ...
  @ApiResponse({ status: 400, description: 'Bad Request. Email may already be in use.' })
  ...
  @ApiResponse({ status: 403, description: 'Forbidden. You can only update your own profile or you must be an admin.' })
  @ApiResponse({ status: 404, description: 'User not found.' })
  update(
    @Param('id') id: string,
